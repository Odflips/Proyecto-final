...
function Home() {
  ...
  return (
    <div className="w-screen h-screen sm:flex ">
      ...
      <div className="mt-20p flex flex-col items-center md:items-end sm:items-end sm:flex sm:flex-col  text-my-white  2xl:w-8/12 p-5 ">
          ...
          <div className="w-full">
            <footer className="bg-the-black h-10 flex justify-center items-center xl:justify-center ">
              <p className="text-my-white">
                Created by{" "}
                <span className=" font-bold underline">Oliver Leal</span> 
                - devChallenges.io
